...
class LlmAssistedRouterStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        # Create API Gateway
        api = apigw.RestApi(
            self, "LlmAssistedRouterApi",
            rest_api_name="LLM-Assisted Router API",
            description="API for LLM-Assisted Router",
        ...
        # Create API key
        api_key = api.add_api_key("LlmAssistedRouterApiKey")

        # Create usage plan
        plan = api.add_usage_plan("LlmAssistedRouterUsagePlan",
            name="Standard",
